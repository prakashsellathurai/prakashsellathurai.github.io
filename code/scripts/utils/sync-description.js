...
const authorPath = path.join(ROOT, 'data', 'non-public', 'authors', 'default.mdx')
const siteMetadataPath = path.join(ROOT, 'data', 'non-public', 'siteMetadata.js')

// Read author file
const file = fs.readFileSync(authorPath, 'utf8').replace(/\r\n/g, '\n')
// Remove frontmatter
