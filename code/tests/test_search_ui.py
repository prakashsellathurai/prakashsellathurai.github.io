...
class TestSearchDropdown:
    def test_dropdown_displays_suggestions_while_typing(self, page):
        page.goto("/notes/")
    ...
    def test_clicking_suggestion_navigates_to_matching_page(self, page):
        page.goto("/notes/")
    ...
    def test_google_row_opens_google_site_search(self, page):
        page.goto("/notes/")
        page.locator("#site-search input[data-search]").fill("cpython")
    ...
    def test_pressing_escape_closes_dropdown(self, page):
        page.goto("/notes/")
        search = page.locator("#site-search input[data-search]")
        search.fill("cpython")
    ...
    def test_search_index_loaded_lazily_on_first_input(self, page):
        page.goto("/notes/")
