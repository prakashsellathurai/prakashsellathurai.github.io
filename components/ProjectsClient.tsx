...
export default function ProjectsClient({ projects }: ProjectsClientProps) {
  ...
  return (
    <>
      {/* Filters Section */}
      <div className="mb-8 space-y-4 rounded-2xl border border-black/10 bg-white/60 p-6 backdrop-blur-md dark:border-white/10 dark:bg-white/5">
        {/* Search Bar */}
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-black/10 bg-white py-3 pl-12 pr-4 text-black placeholder-black/50 transition-all duration-300 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-white/10 dark:bg-white/5 dark:text-white dark:placeholder-white/40 dark:focus:border-primary-400"
          />
        </div>
