...
export default function PostLayout({ content, next, prev, children }: LayoutProps) {
  ...
  return (
    <SectionContainer>
      <ScrollTopAndComment />
      <article className="glass-panel-enhanced animate-diagonal-open mb-8 rounded-3xl bg-black/20 p-6 md:p-10">
        <div>
          <header>
            <div className="space-y-1 border-b border-black/10 pb-10 text-center dark:border-white/10">
              <dl>
                <div>
          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-black/10 pb-8 dark:divide-white/10 xl:divide-y-0">
